...
#define VALA_CCODE_GGNUC_SECTION_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALA_TYPE_CCODE_GGNUC_SECTION, ValaCCodeGGnucSectionPrivate))
...
vala_ccode_ggnuc_section_class_init (ValaCCodeGGnucSectionClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValaCCodeGGnucSectionPrivate));
...
{
	self->priv = VALA_CCODE_GGNUC_SECTION_GET_PRIVATE (self);
}
