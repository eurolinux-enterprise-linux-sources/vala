...
#define VALA_CCODE_DECLARATOR_SUFFIX_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALA_TYPE_CCODE_DECLARATOR_SUFFIX, ValaCCodeDeclaratorSuffixPrivate))
...
vala_ccode_declarator_suffix_class_init (ValaCCodeDeclaratorSuffixClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValaCCodeDeclaratorSuffixPrivate));
}
...
{
	self->priv = VALA_CCODE_DECLARATOR_SUFFIX_GET_PRIVATE (self);
	self->ref_count = 1;
}
