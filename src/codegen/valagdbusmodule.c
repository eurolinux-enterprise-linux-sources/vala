...
void vala_gd_bus_module_receive_dbus_value (ValaGDBusModule* self, ValaDataType* type, ValaCCodeExpression* message_expr, ValaCCodeExpression* iter_expr, ValaCCodeExpression* target_expr, ValaSymbol* sym, ValaCCodeExpression* error_expr, gboolean* may_fail) {
	...
	_tmp6_ = vala_ccode_identifier_new ("_fd");
	fd_var = _tmp6_;
	_tmp7_ = type;
	_tmp8_ = fd_var;
	_tmp9_ = vala_gd_bus_module_create_from_file_descriptor (self, _tmp7_, (ValaCCodeExpression*) _tmp8_);
	stream = _tmp9_;
	_tmp10_ = stream;
	if (_tmp10_ != NULL) {
		...
		_tmp11_ = vala_ccode_identifier_new ("_fd_list");
		fd_list_var = _tmp11_;
		_tmp12_ = vala_ccode_identifier_new ("g_unix_fd_list_get");
		_tmp13_ = _tmp12_;
		...
		_tmp16_ = fd;
		_tmp17_ = fd_list_var;
		vala_ccode_function_call_add_argument (_tmp16_, (ValaCCodeExpression*) _tmp17_);
		_tmp18_ = fd;
		_tmp19_ = vala_ccode_identifier_new ("_fd_index");
		_tmp20_ = _tmp19_;
		...
		_tmp28_ = _tmp27_;
		_tmp29_ = fd_list_var;
		vala_ccode_function_open_if (_tmp28_, (ValaCCodeExpression*) _tmp29_);
		_tmp30_ = vala_ccode_identifier_new ("g_variant_iter_next");
		_tmp31_ = _tmp30_;
		...
		_tmp38_ = get_fd;
		_tmp39_ = vala_ccode_constant_new ("\"h\"");
		_tmp40_ = _tmp39_;
		vala_ccode_function_call_add_argument (_tmp38_, (ValaCCodeExpression*) _tmp40_);
		_vala_ccode_node_unref0 (_tmp40_);
		_tmp41_ = get_fd;
		_tmp42_ = vala_ccode_identifier_new ("_fd_index");
		_tmp43_ = _tmp42_;
		_tmp44_ = vala_ccode_unary_expression_new (VALA_CCODE_UNARY_OPERATOR_ADDRESS_OF, (ValaCCodeExpression*) _tmp43_);
		_tmp45_ = _tmp44_;
		vala_ccode_function_call_add_argument (_tmp41_, (ValaCCodeExpression*) _tmp45_);
		...
		_tmp51_ = fd_var;
		_tmp52_ = fd;
		vala_ccode_function_add_assignment (_tmp50_, (ValaCCodeExpression*) _tmp51_, (ValaCCodeExpression*) _tmp52_);
		_tmp53_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
		_tmp54_ = _tmp53_;
		_tmp55_ = fd_var;
		_tmp56_ = vala_ccode_constant_new ("0");
		_tmp57_ = _tmp56_;
		_tmp58_ = vala_ccode_binary_expression_new (VALA_CCODE_BINARY_OPERATOR_GREATER_THAN_OR_EQUAL, (ValaCCodeExpression*) _tmp55_, (ValaCCodeExpression*) _tmp57_);
		_tmp59_ = _tmp58_;
		vala_ccode_function_open_if (_tmp54_, (ValaCCodeExpression*) _tmp59_);
		...
		_tmp62_ = target_expr;
		_tmp63_ = stream;
		vala_ccode_function_add_assignment (_tmp61_, _tmp62_, _tmp63_);
		_vala_may_fail = TRUE;
		...
		_tmp67_ = _tmp66_;
		vala_ccode_function_add_else (_tmp67_);
		_tmp68_ = vala_ccode_identifier_new ("g_set_error_literal");
		_tmp69_ = _tmp68_;
		...
		_tmp91_ = sym;
		_tmp92_ = error_expr;
		vala_gvariant_module_read_expression ((ValaGVariantModule*) self, _tmp88_, _tmp89_, _tmp90_, _tmp91_, _tmp92_, &_tmp93_);
		_vala_may_fail = _tmp93_;
	}
