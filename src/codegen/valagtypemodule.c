...
static ValaCCodeExpression* vala_gtype_module_cast_method_pointer (ValaGTypeModule* self, ValaMethod* m, ValaCCodeExpression* cfunc, ValaObjectTypeSymbol* base_type, gint direction);
								...
								dim = 1;
								{
									...
									while (TRUE) {
										...
										if (_tmp407_) {
											...
											gchar* _tmp414_ = NULL;
											_tmp410_ = f;
											_tmp411_ = vala_ccode_base_module_get_ccode_name ((ValaCodeNode*) _tmp410_);
											_tmp412_ = _tmp411_;
											_tmp413_ = dim;
						...
						if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp437_, VALA_TYPE_DELEGATE_TYPE)) {
							...
							if (_tmp446_) {
								...
								if (_tmp452_) {
									...
									_tmp454_ = f;
									_tmp455_ = vala_ccode_base_module_get_ccode_name ((ValaCodeNode*) _tmp454_);
									_tmp456_ = _tmp455_;
...
static void vala_gtype_module_real_generate_virtual_method_declaration (ValaGTypeModule* self, ValaMethod* m, ValaCCodeFile* decl_space, ValaCCodeStruct* type_struct) {
	...
	_tmp24_ = vala_hash_map_new (G_TYPE_INT, NULL, NULL, VALA_TYPE_CCODE_PARAMETER, (GBoxedCopyFunc) vala_ccode_node_ref, (GDestroyNotify) vala_ccode_node_unref, _tmp21_, _tmp22_, _tmp23_);
	cparam_map = _tmp24_;
	_tmp25_ = m;
	_tmp26_ = decl_space;
	_tmp27_ = cparam_map;
						...
						if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp155_, VALA_TYPE_DELEGATE_TYPE)) {
							...
							if (_tmp164_) {
								...
								if (_tmp170_) {
									...
									_tmp172_ = f;
									_tmp173_ = vala_ccode_base_module_get_ccode_name ((ValaCodeNode*) _tmp172_);
									_tmp174_ = _tmp173_;
...
static void vala_gtype_module_begin_class_init_function (ValaGTypeModule* self, ValaClass* cl) {
	...
	}
	{
		...
		while (TRUE) {
			...
			ValaObjectTypeSymbol* _tmp152_ = NULL;
			...
			_tmp151_ = _tmp150_;
			_tmp152_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp151_, VALA_TYPE_OBJECT_TYPE_SYMBOL, ValaObjectTypeSymbol));
			base_type = _tmp152_;
			_tmp154_ = m;
			...
			if (_tmp153_) {
				...
				gboolean _tmp197_ = FALSE;
				_tmp160_ = m;
				_tmp161_ = vala_ccode_base_module_get_ccode_real_name ((ValaSymbol*) _tmp160_);
				_tmp162_ = _tmp161_;
				_tmp163_ = vala_ccode_identifier_new (_tmp162_);
				_tmp164_ = (ValaCCodeExpression*) _tmp163_;
				_g_free0 (_tmp162_);
				cfunc = _tmp164_;
				_tmp166_ = m;
				_tmp167_ = vala_method_get_coroutine (_tmp166_);
				_tmp168_ = _tmp167_;
				if (_tmp168_) {
					_tmp165_ = 1;
				} else {
				...
				_tmp172_ = cfunc;
				_tmp173_ = base_type;
				_tmp174_ = vala_gtype_module_cast_method_pointer (self, _tmp171_, _tmp172_, _tmp173_, _tmp165_);
				_vala_ccode_node_unref0 (cfunc);
				cfunc = _tmp174_;
				_tmp175_ = vala_ccode_identifier_new ("klass");
				_tmp176_ = _tmp175_;
				_tmp177_ = base_type;
				_tmp178_ = vala_ccode_base_module_get_ccode_name ((ValaCodeNode*) _tmp177_);
				_tmp179_ = _tmp178_;
				_tmp180_ = g_strdup_printf ("%sClass *", _tmp179_);
				_tmp181_ = _tmp180_;
				_tmp182_ = vala_ccode_cast_expression_new ((ValaCCodeExpression*) _tmp176_, _tmp181_);
				_tmp183_ = _tmp182_;
				_g_free0 (_tmp181_);
				_g_free0 (_tmp179_);
				...
				_tmp186_ = ccast;
				_tmp187_ = m;
				_tmp188_ = vala_method_get_base_method (_tmp187_);
				_tmp189_ = _tmp188_;
				_tmp190_ = vala_ccode_base_module_get_ccode_vfunc_name (_tmp189_);
				_tmp191_ = _tmp190_;
				_tmp192_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp186_, _tmp191_);
				_tmp193_ = _tmp192_;
				_tmp194_ = cfunc;
				vala_ccode_function_add_assignment (_tmp185_, (ValaCCodeExpression*) _tmp193_, _tmp194_);
				...
				if (_tmp197_) {
					...
					ValaObjectTypeSymbol* _tmp206_ = NULL;
					...
					_tmp198_ = m;
					_tmp199_ = vala_ccode_base_module_get_ccode_finish_real_name (_tmp198_);
					_tmp200_ = _tmp199_;
					_tmp201_ = vala_ccode_identifier_new (_tmp200_);
					_vala_ccode_node_unref0 (cfunc);
					cfunc = (ValaCCodeExpression*) _tmp201_;
					_g_free0 (_tmp200_);
					_tmp202_ = m;
					...
					_tmp205_ = cfunc;
					_tmp206_ = base_type;
					_tmp207_ = vala_gtype_module_cast_method_pointer (self, _tmp204_, _tmp205_, _tmp206_, 2);
					_vala_ccode_node_unref0 (cfunc);
					cfunc = _tmp207_;
					...
					_tmp210_ = ccast;
					_tmp211_ = m;
					_tmp212_ = vala_method_get_base_method (_tmp211_);
					_tmp213_ = _tmp212_;
					_tmp214_ = vala_ccode_base_module_get_ccode_finish_vfunc_name (_tmp213_);
					_tmp215_ = _tmp214_;
					_tmp216_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp210_, _tmp215_);
					_tmp217_ = _tmp216_;
					_tmp218_ = cfunc;
					vala_ccode_function_add_assignment (_tmp209_, (ValaCCodeExpression*) _tmp217_, _tmp218_);
	...
	}
	{
		...
		while (TRUE) {
			...
			gchar* _tmp238_ = NULL;
			gchar* _tmp239_ = NULL;
			ValaCCodeCastExpression* _tmp240_ = NULL;
			ValaCCodeCastExpression* _tmp241_ = NULL;
			ValaCCodeFunction* _tmp242_ = NULL;
			ValaCCodeFunction* _tmp243_ = NULL;
			ValaCCodeCastExpression* _tmp244_ = NULL;
			ValaSignal* _tmp245_ = NULL;
			...
			_tmp237_ = _tmp236_;
			_tmp238_ = g_strconcat (_tmp237_, "Class *", NULL);
			_tmp239_ = _tmp238_;
			_tmp240_ = vala_ccode_cast_expression_new ((ValaCCodeExpression*) _tmp234_, _tmp239_);
			_tmp241_ = _tmp240_;
			_g_free0 (_tmp239_);
			_g_free0 (_tmp237_);
			_vala_ccode_node_unref0 (_tmp234_);
			...
			_tmp244_ = ccast;
			_tmp245_ = sig;
			_tmp246_ = vala_signal_get_default_handler (_tmp245_);
			_tmp247_ = _tmp246_;
			_tmp248_ = vala_ccode_base_module_get_ccode_vfunc_name (_tmp247_);
			_tmp249_ = _tmp248_;
			_tmp250_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp244_, _tmp249_);
			_tmp251_ = _tmp250_;
			_tmp252_ = sig;
			_tmp253_ = vala_signal_get_default_handler (_tmp252_);
			_tmp254_ = _tmp253_;
			_tmp255_ = vala_ccode_base_module_get_ccode_real_name ((ValaSymbol*) _tmp254_);
			_tmp256_ = _tmp255_;
			_tmp257_ = vala_ccode_identifier_new (_tmp256_);
			_tmp258_ = _tmp257_;
			vala_ccode_function_add_assignment (_tmp243_, (ValaCCodeExpression*) _tmp251_, (ValaCCodeExpression*) _tmp258_);
	...
	}
	{
		...
		gint _prop_index = 0;
		_tmp259_ = cl;
		_tmp260_ = vala_object_type_symbol_get_properties ((ValaObjectTypeSymbol*) _tmp259_);
		_prop_list = _tmp260_;
		_tmp261_ = _prop_list;
		...
		while (TRUE) {
			...
			ValaProperty* _tmp294_ = NULL;
			gboolean _tmp295_ = FALSE;
			_tmp264_ = _prop_index;
			_prop_index = _tmp264_ + 1;
			...
			_tmp273_ = prop;
			_tmp274_ = vala_property_get_base_property (_tmp273_);
			_tmp275_ = _tmp274_;
			...
			base_type = _tmp278_;
			_tmp279_ = base_type;
			_tmp280_ = vala_ccode_base_module_get_ccode_upper_case_name (_tmp279_, NULL);
			_tmp281_ = _tmp280_;
			_tmp282_ = g_strdup_printf ("%s_CLASS", _tmp281_);
			_tmp283_ = _tmp282_;
			...
			ccast = _tmp287_;
			_tmp288_ = ccast;
			_tmp289_ = vala_ccode_identifier_new ("klass");
			_tmp290_ = _tmp289_;
			vala_ccode_function_call_add_argument (_tmp288_, (ValaCCodeExpression*) _tmp290_);
			_vala_ccode_node_unref0 (_tmp290_);
			_tmp292_ = prop;
			_tmp293_ = vala_property_get_base_property (_tmp292_);
			_tmp294_ = _tmp293_;
			_tmp295_ = vala_ccode_base_module_get_ccode_no_accessor_method (_tmp294_);
			if (!_tmp295_) {
				...
				_tmp296_ = prop;
				_tmp297_ = vala_property_get_base_property (_tmp296_);
				_tmp298_ = _tmp297_;
				_tmp299_ = vala_ccode_base_module_get_ccode_concrete_accessor (_tmp298_);
				_tmp291_ = !_tmp299_;
			} else {
				_tmp291_ = FALSE;
			}
			if (_tmp291_) {
				...
				ValaPropertyAccessor* _tmp301_ = NULL;
				ValaPropertyAccessor* _tmp302_ = NULL;
				ValaProperty* _tmp320_ = NULL;
				ValaPropertyAccessor* _tmp321_ = NULL;
				ValaPropertyAccessor* _tmp322_ = NULL;
				_tmp300_ = prop;
				_tmp301_ = vala_property_get_get_accessor (_tmp300_);
				_tmp302_ = _tmp301_;
				if (_tmp302_ != NULL) {
					gchar* cname = NULL;
					...
					ValaCCodeMemberAccess* _tmp316_ = NULL;
					const gchar* _tmp317_ = NULL;
					ValaCCodeIdentifier* _tmp318_ = NULL;
					ValaCCodeIdentifier* _tmp319_ = NULL;
					_tmp303_ = prop;
					_tmp304_ = vala_property_get_get_accessor (_tmp303_);
					_tmp305_ = _tmp304_;
					_tmp306_ = vala_ccode_base_module_get_ccode_real_name ((ValaSymbol*) _tmp305_);
					cname = _tmp306_;
					...
					_tmp312_ = _tmp311_;
					_tmp313_ = g_strdup_printf ("get_%s", _tmp312_);
					_tmp314_ = _tmp313_;
					_tmp315_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp309_, _tmp314_);
					_tmp316_ = _tmp315_;
					_tmp317_ = cname;
					_tmp318_ = vala_ccode_identifier_new (_tmp317_);
					_tmp319_ = _tmp318_;
					vala_ccode_function_add_assignment (_tmp308_, (ValaCCodeExpression*) _tmp316_, (ValaCCodeExpression*) _tmp319_);
				...
				if (_tmp322_ != NULL) {
					gchar* cname = NULL;
					ValaProperty* _tmp323_ = NULL;
					ValaPropertyAccessor* _tmp324_ = NULL;
					...
					_tmp332_ = _tmp331_;
					_tmp333_ = g_strdup_printf ("set_%s", _tmp332_);
					_tmp334_ = _tmp333_;
					_tmp335_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp329_, _tmp334_);
					_tmp336_ = _tmp335_;
					_tmp337_ = cname;
					_tmp338_ = vala_ccode_identifier_new (_tmp337_);
					_tmp339_ = _tmp338_;
					vala_ccode_function_add_assignment (_tmp328_, (ValaCCodeExpression*) _tmp336_, (ValaCCodeExpression*) _tmp339_);
	...
	_tmp340_ = cl;
	vala_gtype_module_generate_class_init (self, _tmp340_);
	_tmp341_ = cl;
	_tmp342_ = vala_class_get_is_compact (_tmp341_);
	_tmp343_ = _tmp342_;
	if (!_tmp343_) {
		{
			ValaList* _sig_list = NULL;
			ValaClass* _tmp344_ = NULL;
			ValaList* _tmp345_ = NULL;
			gint _sig_size = 0;
			...
			gint _sig_index = 0;
			_tmp344_ = cl;
			_tmp345_ = vala_object_type_symbol_get_signals ((ValaObjectTypeSymbol*) _tmp344_);
			_sig_list = _tmp345_;
			_tmp346_ = _sig_list;
			...
			while (TRUE) {
				...
				sig = (ValaSignal*) _tmp354_;
				_tmp355_ = sig;
				_tmp356_ = vala_symbol_get_comment ((ValaSymbol*) _tmp355_);
				_tmp357_ = _tmp356_;
				if (_tmp357_ != NULL) {
					ValaCCodeFunction* _tmp358_ = NULL;
					ValaCCodeFunction* _tmp359_ = NULL;
					ValaSignal* _tmp360_ = NULL;
					ValaComment* _tmp361_ = NULL;
					ValaComment* _tmp362_ = NULL;
					const gchar* _tmp363_ = NULL;
					const gchar* _tmp364_ = NULL;
					ValaCCodeComment* _tmp365_ = NULL;
					ValaCCodeComment* _tmp366_ = NULL;
					_tmp358_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
					_tmp359_ = _tmp358_;
					_tmp360_ = sig;
					_tmp361_ = vala_symbol_get_comment ((ValaSymbol*) _tmp360_);
					_tmp362_ = _tmp361_;
					_tmp363_ = vala_comment_get_content (_tmp362_);
					_tmp364_ = _tmp363_;
					_tmp365_ = vala_ccode_comment_new (_tmp364_);
					_tmp366_ = _tmp365_;
					vala_ccode_function_add_statement (_tmp359_, (ValaCCodeNode*) _tmp366_);
				...
				_tmp369_ = sig;
				_tmp370_ = cl;
				_tmp371_ = vala_ccode_base_module_get_signal_creation ((ValaCCodeBaseModule*) self, _tmp369_, (ValaTypeSymbol*) _tmp370_);
				_tmp372_ = _tmp371_;
				vala_ccode_function_add_expression (_tmp368_, (ValaCCodeExpression*) _tmp372_);
...
static void vala_gtype_module_add_interface_init_function (ValaGTypeModule* self, ValaClass* cl, ValaInterface* iface) {
	...
	ValaCCodeIdentifier* _tmp55_ = NULL;
	ValaCCodeFunctionCall* _tmp56_ = NULL;
	ValaInterface* _tmp151_ = NULL;
	ValaAttribute* _tmp152_ = NULL;
	ValaAttribute* _tmp153_ = NULL;
	gboolean _tmp154_ = FALSE;
	ValaCCodeFile* _tmp522_ = NULL;
	...
	_vala_ccode_node_unref0 (_tmp55_);
	{
		...
		while (TRUE) {
			...
			ValaCCodeMemberAccess* _tmp114_ = NULL;
			...
			_tmp102_ = cfunc;
			_tmp103_ = iface;
			_tmp104_ = vala_gtype_module_cast_method_pointer (self, _tmp101_, _tmp102_, (ValaObjectTypeSymbol*) _tmp103_, _tmp95_);
			_vala_ccode_node_unref0 (cfunc);
			cfunc = _tmp104_;
			...
			_tmp107_ = ciface;
			_tmp108_ = m;
			_tmp109_ = vala_method_get_base_interface_method (_tmp108_);
			_tmp110_ = _tmp109_;
			_tmp111_ = vala_ccode_base_module_get_ccode_vfunc_name (_tmp110_);
			_tmp112_ = _tmp111_;
			...
			if (_tmp118_) {
				...
				_tmp120_ = m;
				_tmp121_ = vala_method_get_is_abstract (_tmp120_);
				_tmp122_ = _tmp121_;
				if (_tmp122_) {
					_tmp119_ = TRUE;
				} else {
					...
					gboolean _tmp125_ = FALSE;
					_tmp123_ = m;
					_tmp124_ = vala_method_get_is_virtual (_tmp123_);
					_tmp125_ = _tmp124_;
					_tmp119_ = _tmp125_;
				}
				if (_tmp119_) {
					...
					_tmp126_ = m;
					_tmp127_ = vala_ccode_base_module_get_ccode_finish_name (_tmp126_);
					_tmp128_ = _tmp127_;
					...
					_tmp130_ = m;
					_tmp131_ = vala_ccode_base_module_get_ccode_finish_real_name (_tmp130_);
					_tmp132_ = _tmp131_;
					_tmp133_ = vala_ccode_identifier_new (_tmp132_);
					_vala_ccode_node_unref0 (cfunc);
					cfunc = (ValaCCodeExpression*) _tmp133_;
					_g_free0 (_tmp132_);
				}
				_tmp134_ = m;
				...
				_tmp137_ = cfunc;
				_tmp138_ = iface;
				_tmp139_ = vala_gtype_module_cast_method_pointer (self, _tmp136_, _tmp137_, (ValaObjectTypeSymbol*) _tmp138_, 2);
				_vala_ccode_node_unref0 (cfunc);
				cfunc = _tmp139_;
				...
				_tmp145_ = _tmp144_;
				_tmp146_ = vala_ccode_base_module_get_ccode_finish_vfunc_name (_tmp145_);
				_tmp147_ = _tmp146_;
				_tmp148_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp142_, _tmp147_);
				_tmp149_ = _tmp148_;
				_tmp150_ = cfunc;
				vala_ccode_function_add_assignment (_tmp141_, (ValaCCodeExpression*) _tmp149_, _tmp150_);
	...
	_tmp151_ = iface;
	_tmp152_ = vala_code_node_get_attribute ((ValaCodeNode*) _tmp151_, "GenericAccessors");
	_tmp153_ = _tmp152_;
	...
	if (_tmp154_) {
		{
			...
			gint _p_index = 0;
			_tmp155_ = iface;
			_tmp156_ = vala_object_type_symbol_get_type_parameters ((ValaObjectTypeSymbol*) _tmp155_);
			_p_list = _tmp156_;
			_tmp157_ = _p_list;
			...
			while (TRUE) {
				...
				ValaGenericType* _tmp167_ = NULL;
				ValaDataType* p_data_type = NULL;
				ValaGenericType* _tmp168_ = NULL;
				ValaClass* _tmp169_ = NULL;
				...
				ValaTypeParameter* _tmp198_ = NULL;
				ValaClass* _tmp199_ = NULL;
				ValaInterface* _tmp200_ = NULL;
				...
				ValaTypeParameter* _tmp211_ = NULL;
				ValaClass* _tmp212_ = NULL;
				ValaInterface* _tmp213_ = NULL;
				_tmp160_ = _p_index;
				_p_index = _tmp160_ + 1;
				_tmp161_ = _p_index;
				_tmp162_ = _p_size;
				...
				p = (ValaTypeParameter*) _tmp165_;
				_tmp166_ = p;
				_tmp167_ = vala_generic_type_new (_tmp166_);
				p_type = _tmp167_;
				_tmp168_ = p_type;
				_tmp169_ = cl;
				_tmp170_ = vala_ccode_base_module_get_data_type_for_symbol ((ValaTypeSymbol*) _tmp169_);
				_tmp171_ = _tmp170_;
				_tmp172_ = cl;
				_tmp173_ = vala_data_type_get_actual_type ((ValaDataType*) _tmp168_, _tmp171_, NULL, (ValaCodeNode*) _tmp172_);
				_tmp174_ = _tmp173_;
				_vala_code_node_unref0 (_tmp171_);
				p_data_type = _tmp174_;
				_tmp175_ = p;
				_tmp176_ = vala_symbol_get_name ((ValaSymbol*) _tmp175_);
				_tmp177_ = _tmp176_;
				_tmp178_ = g_utf8_strdown (_tmp177_, (gssize) -1);
				_tmp179_ = _tmp178_;
				_tmp180_ = g_strdup_printf ("get_%s_type", _tmp179_);
				_tmp181_ = _tmp180_;
				_tmp182_ = p_data_type;
				_tmp183_ = vala_ccode_base_module_get_type_id_expression ((ValaCCodeBaseModule*) self, _tmp182_, FALSE);
				_tmp184_ = _tmp183_;
				_tmp185_ = p;
				_tmp186_ = cl;
				_tmp187_ = iface;
				vala_gtype_module_add_generic_accessor_function (self, _tmp181_, "GType", _tmp184_, _tmp185_, _tmp186_, _tmp187_);
				_vala_ccode_node_unref0 (_tmp184_);
				_g_free0 (_tmp181_);
				_g_free0 (_tmp179_);
				_tmp188_ = p;
				...
				_tmp192_ = _tmp191_;
				_tmp193_ = g_strdup_printf ("get_%s_dup_func", _tmp192_);
				_tmp194_ = _tmp193_;
				_tmp195_ = p_data_type;
				_tmp196_ = vala_ccode_base_module_get_dup_func_expression ((ValaCCodeBaseModule*) self, _tmp195_, NULL, FALSE);
				_tmp197_ = _tmp196_;
				_tmp198_ = p;
				_tmp199_ = cl;
				_tmp200_ = iface;
				vala_gtype_module_add_generic_accessor_function (self, _tmp194_, "GBoxedCopyFunc", _tmp197_, _tmp198_, _tmp199_, _tmp200_);
				...
				_tmp203_ = _tmp202_;
				_tmp204_ = g_utf8_strdown (_tmp203_, (gssize) -1);
				_tmp205_ = _tmp204_;
				_tmp206_ = g_strdup_printf ("get_%s_destroy_func", _tmp205_);
				_tmp207_ = _tmp206_;
				_tmp208_ = p_data_type;
				_tmp209_ = vala_ccode_base_module_get_destroy_func_expression ((ValaCCodeBaseModule*) self, _tmp208_, FALSE);
				_tmp210_ = _tmp209_;
				_tmp211_ = p;
				_tmp212_ = cl;
				_tmp213_ = iface;
				vala_gtype_module_add_generic_accessor_function (self, _tmp207_, "GDestroyNotify", _tmp210_, _tmp211_, _tmp212_, _tmp213_);
				_vala_ccode_node_unref0 (_tmp210_);
				_g_free0 (_tmp207_);
				_g_free0 (_tmp205_);
	...
	}
	{
		...
		gint _m_index = 0;
		_tmp214_ = iface;
		_tmp215_ = vala_object_type_symbol_get_methods ((ValaObjectTypeSymbol*) _tmp214_);
		_m_list = _tmp215_;
		_tmp216_ = _m_list;
		...
		while (TRUE) {
			...
			m = (ValaMethod*) _tmp224_;
			_tmp225_ = m;
			_tmp226_ = vala_method_get_is_abstract (_tmp225_);
			_tmp227_ = _tmp226_;
			if (_tmp227_) {
				...
				while (TRUE) {
					...
					ValaScope* _tmp234_ = NULL;
					ValaScope* _tmp235_ = NULL;
					...
					_tmp233_ = base_class;
					_tmp234_ = vala_symbol_get_scope ((ValaSymbol*) _tmp233_);
					_tmp235_ = _tmp234_;
					_tmp236_ = m;
					_tmp237_ = vala_symbol_get_name ((ValaSymbol*) _tmp236_);
					_tmp238_ = _tmp237_;
					_tmp239_ = vala_scope_lookup (_tmp235_, _tmp238_);
					_tmp240_ = G_TYPE_CHECK_INSTANCE_TYPE (_tmp239_, VALA_TYPE_METHOD) ? ((ValaMethod*) _tmp239_) : NULL;
					if (_tmp240_ == NULL) {
					...
					cl_method = _tmp240_;
					_tmp241_ = base_class;
					_tmp242_ = vala_class_get_base_class (_tmp241_);
					_tmp243_ = _tmp242_;
					_tmp244_ = _vala_code_node_ref0 (_tmp243_);
				...
				if (_tmp246_ != NULL) {
					...
					ValaClass* _tmp250_ = NULL;
					_tmp247_ = cl_method;
					_tmp248_ = vala_symbol_get_parent_symbol ((ValaSymbol*) _tmp247_);
					_tmp249_ = _tmp248_;
					_tmp250_ = cl;
					_tmp245_ = _tmp249_ != G_TYPE_CHECK_INSTANCE_CAST (_tmp250_, VALA_TYPE_SYMBOL, ValaSymbol);
				} else {
					_tmp245_ = FALSE;
				}
				if (_tmp245_) {
					...
					gchar* _tmp283_ = NULL;
					gchar* _tmp284_ = NULL;
					ValaCCodeMemberAccess* _tmp285_ = NULL;
					...
					_tmp253_ = cl_method;
					_tmp254_ = vala_method_get_base_method (_tmp253_);
					_tmp255_ = _tmp254_;
					if (_tmp255_ != NULL) {
						...
						_tmp256_ = cl_method;
						_tmp257_ = vala_method_get_base_method (_tmp256_);
						_tmp258_ = _tmp257_;
						...
						_tmp260_ = cl_method;
						_tmp261_ = vala_method_get_base_interface_method (_tmp260_);
						_tmp262_ = _tmp261_;
						if (_tmp262_ != NULL) {
							...
							_tmp263_ = cl_method;
							_tmp264_ = vala_method_get_base_interface_method (_tmp263_);
							_tmp265_ = _tmp264_;
							_tmp266_ = _vala_code_node_ref0 (_tmp265_);
							_vala_code_node_unref0 (base_method);
							base_method = _tmp266_;
						}
					}
					_tmp267_ = base_method;
					_tmp268_ = ((ValaCCodeBaseModule*) self)->cfile;
					vala_ccode_base_module_generate_method_declaration ((ValaCCodeBaseModule*) self, _tmp267_, _tmp268_);
					_tmp269_ = base_method;
					_tmp270_ = vala_ccode_base_module_get_ccode_name ((ValaCodeNode*) _tmp269_);
					_tmp271_ = _tmp270_;
					_tmp272_ = vala_ccode_identifier_new (_tmp271_);
					_tmp273_ = (ValaCCodeExpression*) _tmp272_;
					_g_free0 (_tmp271_);
					cfunc = _tmp273_;
					_tmp274_ = base_method;
					_tmp275_ = cfunc;
					_tmp276_ = iface;
					_tmp277_ = vala_gtype_module_cast_method_pointer (self, _tmp274_, _tmp275_, (ValaObjectTypeSymbol*) _tmp276_, 3);
					_vala_ccode_node_unref0 (cfunc);
					cfunc = _tmp277_;
					_tmp278_ = vala_ccode_identifier_new ("iface");
					ciface = _tmp278_;
					_tmp279_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
					_tmp280_ = _tmp279_;
					_tmp281_ = ciface;
					_tmp282_ = m;
					_tmp283_ = vala_ccode_base_module_get_ccode_vfunc_name (_tmp282_);
					_tmp284_ = _tmp283_;
					_tmp285_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp281_, _tmp284_);
					_tmp286_ = _tmp285_;
					_tmp287_ = cfunc;
					vala_ccode_function_add_assignment (_tmp280_, (ValaCCodeExpression*) _tmp286_, _tmp287_);
	...
	}
	{
		...
		gint _prop_index = 0;
		_tmp288_ = cl;
		_tmp289_ = vala_object_type_symbol_get_properties ((ValaObjectTypeSymbol*) _tmp288_);
		_prop_list = _tmp289_;
		_tmp290_ = _prop_list;
		...
		while (TRUE) {
			...
			ValaObjectTypeSymbol* _tmp307_ = NULL;
			ValaObjectTypeSymbol* _tmp308_ = NULL;
			ValaInterface* _tmp309_ = NULL;
			ValaCCodeIdentifier* ciface = NULL;
			...
			gboolean _tmp315_ = FALSE;
			_tmp293_ = _prop_index;
			_prop_index = _tmp293_ + 1;
			_tmp294_ = _prop_index;
			_tmp295_ = _prop_size;
			if (!(_tmp294_ < _tmp295_)) {
				break;
			}
			_tmp296_ = _prop_list;
			_tmp297_ = _prop_index;
			_tmp298_ = vala_list_get (_tmp296_, _tmp297_);
			prop = (ValaProperty*) _tmp298_;
			_tmp299_ = prop;
			_tmp300_ = vala_property_get_base_interface_property (_tmp299_);
			_tmp301_ = _tmp300_;
			if (_tmp301_ == NULL) {
				_vala_code_node_unref0 (prop);
				continue;
			...
			_tmp306_ = _tmp305_;
			_tmp307_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp306_, VALA_TYPE_OBJECT_TYPE_SYMBOL, ValaObjectTypeSymbol));
			base_type = _tmp307_;
			_tmp308_ = base_type;
			_tmp309_ = iface;
			if (_tmp308_ != G_TYPE_CHECK_INSTANCE_CAST (_tmp309_, VALA_TYPE_OBJECT_TYPE_SYMBOL, ValaObjectTypeSymbol)) {
				_vala_code_node_unref0 (base_type);
				_vala_code_node_unref0 (prop);
				continue;
			}
			_tmp310_ = vala_ccode_identifier_new ("iface");
			ciface = _tmp310_;
			_tmp312_ = prop;
			_tmp313_ = vala_property_get_base_interface_property (_tmp312_);
			_tmp314_ = _tmp313_;
			_tmp315_ = vala_ccode_base_module_get_ccode_no_accessor_method (_tmp314_);
			if (!_tmp315_) {
				...
				_tmp316_ = prop;
				_tmp317_ = vala_property_get_base_interface_property (_tmp316_);
				_tmp318_ = _tmp317_;
				_tmp319_ = vala_ccode_base_module_get_ccode_concrete_accessor (_tmp318_);
				_tmp311_ = !_tmp319_;
			} else {
				_tmp311_ = FALSE;
			}
			if (_tmp311_) {
				...
				ValaPropertyAccessor* _tmp321_ = NULL;
				ValaPropertyAccessor* _tmp322_ = NULL;
				ValaProperty* _tmp364_ = NULL;
				ValaPropertyAccessor* _tmp365_ = NULL;
				ValaPropertyAccessor* _tmp366_ = NULL;
				_tmp320_ = prop;
				_tmp321_ = vala_property_get_get_accessor (_tmp320_);
				_tmp322_ = _tmp321_;
				if (_tmp322_ != NULL) {
					gchar* cname = NULL;
					ValaProperty* _tmp323_ = NULL;
					...
					cname = _tmp326_;
					_tmp328_ = prop;
					_tmp329_ = vala_property_get_is_abstract (_tmp328_);
					_tmp330_ = _tmp329_;
					if (_tmp330_) {
						_tmp327_ = TRUE;
					} else {
						...
						_tmp331_ = prop;
						_tmp332_ = vala_property_get_is_virtual (_tmp331_);
						_tmp333_ = _tmp332_;
						_tmp327_ = _tmp333_;
					}
					if (_tmp327_) {
						ValaProperty* _tmp334_ = NULL;
						ValaPropertyAccessor* _tmp335_ = NULL;
						ValaPropertyAccessor* _tmp336_ = NULL;
						gchar* _tmp337_ = NULL;
						_tmp334_ = prop;
						_tmp335_ = vala_property_get_get_accessor (_tmp334_);
						_tmp336_ = _tmp335_;
					...
					cfunc = (ValaCCodeExpression*) _tmp339_;
					_tmp341_ = prop;
					_tmp342_ = vala_property_get_is_abstract (_tmp341_);
					_tmp343_ = _tmp342_;
					if (_tmp343_) {
						_tmp340_ = TRUE;
					} else {
						ValaProperty* _tmp344_ = NULL;
						gboolean _tmp345_ = FALSE;
						gboolean _tmp346_ = FALSE;
						_tmp344_ = prop;
						_tmp345_ = vala_property_get_is_virtual (_tmp344_);
						_tmp346_ = _tmp345_;
						_tmp340_ = _tmp346_;
					}
					if (_tmp340_) {
						...
						ValaPropertyAccessor* _tmp349_ = NULL;
						ValaCCodeExpression* _tmp350_ = NULL;
						ValaObjectTypeSymbol* _tmp351_ = NULL;
						ValaCCodeExpression* _tmp352_ = NULL;
						_tmp347_ = prop;
						_tmp348_ = vala_property_get_get_accessor (_tmp347_);
						_tmp349_ = _tmp348_;
						_tmp350_ = cfunc;
						_tmp351_ = base_type;
						_tmp352_ = vala_gtype_module_cast_property_accessor_pointer (self, _tmp349_, _tmp350_, _tmp351_);
						_vala_ccode_node_unref0 (cfunc);
						cfunc = _tmp352_;
					}
					...
					_tmp362_ = _tmp361_;
					_tmp363_ = cfunc;
					vala_ccode_function_add_assignment (_tmp354_, (ValaCCodeExpression*) _tmp362_, _tmp363_);
					_vala_ccode_node_unref0 (_tmp362_);
					_g_free0 (_tmp360_);
					_vala_ccode_node_unref0 (cfunc);
					_g_free0 (cname);
				...
				_tmp364_ = prop;
				_tmp365_ = vala_property_get_set_accessor (_tmp364_);
				_tmp366_ = _tmp365_;
				if (_tmp366_ != NULL) {
					gchar* cname = NULL;
					ValaProperty* _tmp367_ = NULL;
					ValaPropertyAccessor* _tmp368_ = NULL;
					ValaPropertyAccessor* _tmp369_ = NULL;
					gchar* _tmp370_ = NULL;
					gboolean _tmp371_ = FALSE;
					ValaProperty* _tmp372_ = NULL;
					...
					_tmp367_ = prop;
					_tmp368_ = vala_property_get_set_accessor (_tmp367_);
					_tmp369_ = _tmp368_;
					...
					if (_tmp374_) {
						...
						gboolean _tmp377_ = FALSE;
						_tmp375_ = prop;
						_tmp376_ = vala_property_get_is_virtual (_tmp375_);
						_tmp377_ = _tmp376_;
						_tmp371_ = _tmp377_;
					}
					if (_tmp371_) {
						ValaProperty* _tmp378_ = NULL;
						ValaPropertyAccessor* _tmp379_ = NULL;
						ValaPropertyAccessor* _tmp380_ = NULL;
						gchar* _tmp381_ = NULL;
						_tmp378_ = prop;
						_tmp379_ = vala_property_get_set_accessor (_tmp378_);
						_tmp380_ = _tmp379_;
						_tmp381_ = vala_ccode_base_module_get_ccode_name ((ValaCodeNode*) _tmp380_);
						_g_free0 (cname);
						cname = _tmp381_;
					}
					_tmp382_ = cname;
					_tmp383_ = vala_ccode_identifier_new (_tmp382_);
					cfunc = (ValaCCodeExpression*) _tmp383_;
					_tmp385_ = prop;
					_tmp386_ = vala_property_get_is_abstract (_tmp385_);
					_tmp387_ = _tmp386_;
					if (_tmp387_) {
						_tmp384_ = TRUE;
					} else {
						ValaProperty* _tmp388_ = NULL;
						gboolean _tmp389_ = FALSE;
						gboolean _tmp390_ = FALSE;
						_tmp388_ = prop;
						_tmp389_ = vala_property_get_is_virtual (_tmp388_);
						_tmp390_ = _tmp389_;
						_tmp384_ = _tmp390_;
					}
					if (_tmp384_) {
						ValaProperty* _tmp391_ = NULL;
						ValaPropertyAccessor* _tmp392_ = NULL;
						ValaPropertyAccessor* _tmp393_ = NULL;
						ValaCCodeExpression* _tmp394_ = NULL;
						ValaObjectTypeSymbol* _tmp395_ = NULL;
						ValaCCodeExpression* _tmp396_ = NULL;
						_tmp391_ = prop;
						_tmp392_ = vala_property_get_set_accessor (_tmp391_);
						_tmp393_ = _tmp392_;
						_tmp394_ = cfunc;
						_tmp395_ = base_type;
						_tmp396_ = vala_gtype_module_cast_property_accessor_pointer (self, _tmp393_, _tmp394_, _tmp395_);
						_vala_ccode_node_unref0 (cfunc);
						cfunc = _tmp396_;
					}
					...
					_tmp402_ = _tmp401_;
					_tmp403_ = g_strdup_printf ("set_%s", _tmp402_);
					_tmp404_ = _tmp403_;
					_tmp405_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp399_, _tmp404_);
					_tmp406_ = _tmp405_;
					_tmp407_ = cfunc;
					vala_ccode_function_add_assignment (_tmp398_, (ValaCCodeExpression*) _tmp406_, _tmp407_);
	...
	}
	{
		...
		gint _prop_index = 0;
		_tmp408_ = iface;
		_tmp409_ = vala_object_type_symbol_get_properties ((ValaObjectTypeSymbol*) _tmp408_);
		_prop_list = _tmp409_;
		_tmp410_ = _prop_list;
		...
		while (TRUE) {
			...
			gint _tmp415_ = 0;
			ValaProperty* prop = NULL;
			ValaList* _tmp416_ = NULL;
			gint _tmp417_ = 0;
			gpointer _tmp418_ = NULL;
			...
			ValaClass* _tmp440_ = NULL;
			_tmp413_ = _prop_index;
			_prop_index = _tmp413_ + 1;
			_tmp414_ = _prop_index;
			_tmp415_ = _prop_size;
			if (!(_tmp414_ < _tmp415_)) {
				break;
			}
			_tmp416_ = _prop_list;
			_tmp417_ = _prop_index;
			_tmp418_ = vala_list_get (_tmp416_, _tmp417_);
			prop = (ValaProperty*) _tmp418_;
			_tmp419_ = prop;
			_tmp420_ = vala_property_get_is_abstract (_tmp419_);
			_tmp421_ = _tmp420_;
			if (!_tmp421_) {
				_vala_code_node_unref0 (prop);
				continue;
			...
			while (TRUE) {
				...
				ValaScope* _tmp428_ = NULL;
				ValaScope* _tmp429_ = NULL;
				...
				ValaClass* _tmp435_ = NULL;
				ValaClass* _tmp436_ = NULL;
				ValaClass* _tmp437_ = NULL;
				ValaClass* _tmp438_ = NULL;
				_tmp425_ = base_class;
				if (_tmp425_ != NULL) {
					ValaProperty* _tmp426_ = NULL;
					_tmp426_ = cl_prop;
					_tmp424_ = _tmp426_ == NULL;
				} else {
					_tmp424_ = FALSE;
				}
				if (!_tmp424_) {
				...
				_tmp427_ = base_class;
				_tmp428_ = vala_symbol_get_scope ((ValaSymbol*) _tmp427_);
				_tmp429_ = _tmp428_;
				_tmp430_ = prop;
				_tmp431_ = vala_symbol_get_name ((ValaSymbol*) _tmp430_);
				_tmp432_ = _tmp431_;
				_tmp433_ = vala_scope_lookup (_tmp429_, _tmp432_);
				_tmp434_ = G_TYPE_CHECK_INSTANCE_TYPE (_tmp433_, VALA_TYPE_PROPERTY) ? ((ValaProperty*) _tmp433_) : NULL;
				if (_tmp434_ == NULL) {
				...
				cl_prop = _tmp434_;
				_tmp435_ = base_class;
				_tmp436_ = vala_class_get_base_class (_tmp435_);
				_tmp437_ = _tmp436_;
			...
			if (_tmp440_ != NULL) {
				...
				ValaSymbol* _tmp442_ = NULL;
				ValaSymbol* _tmp443_ = NULL;
				ValaClass* _tmp444_ = NULL;
				_tmp441_ = cl_prop;
				_tmp442_ = vala_symbol_get_parent_symbol ((ValaSymbol*) _tmp441_);
				_tmp443_ = _tmp442_;
				_tmp444_ = cl;
				_tmp439_ = _tmp443_ != G_TYPE_CHECK_INSTANCE_CAST (_tmp444_, VALA_TYPE_SYMBOL, ValaSymbol);
			} else {
				_tmp439_ = FALSE;
			}
			if (_tmp439_) {
				...
				_tmp447_ = cl_prop;
				_tmp448_ = vala_property_get_base_property (_tmp447_);
				_tmp449_ = _tmp448_;
				if (_tmp449_ != NULL) {
					...
					_tmp450_ = cl_prop;
					_tmp451_ = vala_property_get_base_property (_tmp450_);
					_tmp452_ = _tmp451_;
					...
					_tmp454_ = cl_prop;
					_tmp455_ = vala_property_get_base_interface_property (_tmp454_);
					_tmp456_ = _tmp455_;
					if (_tmp456_ != NULL) {
						ValaProperty* _tmp457_ = NULL;
						ValaProperty* _tmp458_ = NULL;
						ValaProperty* _tmp459_ = NULL;
						ValaProperty* _tmp460_ = NULL;
						_tmp457_ = cl_prop;
						_tmp458_ = vala_property_get_base_interface_property (_tmp457_);
						_tmp459_ = _tmp458_;
						_tmp460_ = _vala_code_node_ref0 (_tmp459_);
						_vala_code_node_unref0 (base_property);
						base_property = _tmp460_;
					}
				}
				_tmp461_ = vala_ccode_identifier_new ("iface");
				ciface = _tmp461_;
				...
				if (_tmp464_ != NULL) {
					...
					ValaCCodeFile* _tmp468_ = NULL;
					gchar* cname = NULL;
					ValaProperty* _tmp469_ = NULL;
					ValaPropertyAccessor* _tmp470_ = NULL;
					...
					ValaPropertyAccessor* _tmp476_ = NULL;
					ValaPropertyAccessor* _tmp477_ = NULL;
					ValaCCodeExpression* _tmp478_ = NULL;
					ValaInterface* _tmp479_ = NULL;
					...
					ValaCCodeExpression* _tmp491_ = NULL;
					_tmp465_ = base_property;
					_tmp466_ = vala_property_get_get_accessor (_tmp465_);
					_tmp467_ = _tmp466_;
					_tmp468_ = ((ValaCCodeBaseModule*) self)->cfile;
					vala_ccode_base_module_generate_property_accessor_declaration ((ValaCCodeBaseModule*) self, _tmp467_, _tmp468_);
					_tmp469_ = base_property;
					_tmp470_ = vala_property_get_get_accessor (_tmp469_);
					_tmp471_ = _tmp470_;
					_tmp472_ = vala_ccode_base_module_get_ccode_name ((ValaCodeNode*) _tmp471_);
					cname = _tmp472_;
					_tmp473_ = cname;
					_tmp474_ = vala_ccode_identifier_new (_tmp473_);
					cfunc = (ValaCCodeExpression*) _tmp474_;
					_tmp475_ = prop;
					_tmp476_ = vala_property_get_get_accessor (_tmp475_);
					_tmp477_ = _tmp476_;
					_tmp478_ = cfunc;
					_tmp479_ = iface;
					_tmp480_ = vala_gtype_module_cast_property_accessor_pointer (self, _tmp477_, _tmp478_, (ValaObjectTypeSymbol*) _tmp479_);
					_vala_ccode_node_unref0 (cfunc);
					cfunc = _tmp480_;
					...
					_tmp486_ = _tmp485_;
					_tmp487_ = g_strdup_printf ("get_%s", _tmp486_);
					_tmp488_ = _tmp487_;
					_tmp489_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp483_, _tmp488_);
					_tmp490_ = _tmp489_;
					_tmp491_ = cfunc;
					vala_ccode_function_add_assignment (_tmp482_, (ValaCCodeExpression*) _tmp490_, _tmp491_);
				...
				if (_tmp494_ != NULL) {
					...
					ValaCCodeFile* _tmp498_ = NULL;
					gchar* cname = NULL;
					ValaProperty* _tmp499_ = NULL;
					ValaPropertyAccessor* _tmp500_ = NULL;
					...
					ValaPropertyAccessor* _tmp506_ = NULL;
					ValaPropertyAccessor* _tmp507_ = NULL;
					ValaCCodeExpression* _tmp508_ = NULL;
					ValaInterface* _tmp509_ = NULL;
					...
					gchar* _tmp517_ = NULL;
					gchar* _tmp518_ = NULL;
					ValaCCodeMemberAccess* _tmp519_ = NULL;
					ValaCCodeMemberAccess* _tmp520_ = NULL;
					ValaCCodeExpression* _tmp521_ = NULL;
					_tmp495_ = base_property;
					_tmp496_ = vala_property_get_set_accessor (_tmp495_);
					_tmp497_ = _tmp496_;
					_tmp498_ = ((ValaCCodeBaseModule*) self)->cfile;
					vala_ccode_base_module_generate_property_accessor_declaration ((ValaCCodeBaseModule*) self, _tmp497_, _tmp498_);
					_tmp499_ = base_property;
					_tmp500_ = vala_property_get_set_accessor (_tmp499_);
					_tmp501_ = _tmp500_;
					_tmp502_ = vala_ccode_base_module_get_ccode_name ((ValaCodeNode*) _tmp501_);
					cname = _tmp502_;
					_tmp503_ = cname;
					_tmp504_ = vala_ccode_identifier_new (_tmp503_);
					cfunc = (ValaCCodeExpression*) _tmp504_;
					_tmp505_ = prop;
					_tmp506_ = vala_property_get_set_accessor (_tmp505_);
					_tmp507_ = _tmp506_;
					_tmp508_ = cfunc;
					_tmp509_ = iface;
					_tmp510_ = vala_gtype_module_cast_property_accessor_pointer (self, _tmp507_, _tmp508_, (ValaObjectTypeSymbol*) _tmp509_);
					_vala_ccode_node_unref0 (cfunc);
					cfunc = _tmp510_;
					...
					_tmp516_ = _tmp515_;
					_tmp517_ = g_strdup_printf ("set_%s", _tmp516_);
					_tmp518_ = _tmp517_;
					_tmp519_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp513_, _tmp518_);
					_tmp520_ = _tmp519_;
					_tmp521_ = cfunc;
					vala_ccode_function_add_assignment (_tmp512_, (ValaCCodeExpression*) _tmp520_, _tmp521_);
	...
	vala_ccode_base_module_pop_function ((ValaCCodeBaseModule*) self);
	_tmp522_ = ((ValaCCodeBaseModule*) self)->cfile;
	_tmp523_ = iface_init;
	vala_ccode_file_add_function (_tmp522_, _tmp523_);
	_vala_ccode_node_unref0 (parent_var_decl);
	_vala_ccode_node_unref0 (parent_decl);
...
static ValaCCodeExpression* vala_gtype_module_cast_method_pointer (ValaGTypeModule* self, ValaMethod* m, ValaCCodeExpression* cfunc, ValaObjectTypeSymbol* base_type, gint direction) {
	...
	ValaCCodeFunctionDeclarator* _tmp22_ = NULL;
	ValaHashMap* cparam_map = NULL;
	...
	ValaCCodeFunction* _tmp30_ = NULL;
	ValaCCodeFunction* _tmp31_ = NULL;
	ValaCCodeFunctionDeclarator* _tmp32_ = NULL;
	gint _tmp33_ = 0;
	gint last_pos = 0;
	gint min_pos = 0;
	...
	ValaCCodeCastExpression* _tmp78_ = NULL;
	g_return_val_if_fail (self != NULL, NULL);
	...
	if (_tmp1_ == 1) {
		...
		gboolean _tmp5_ = FALSE;
		_tmp2_ = m;
		_tmp3_ = vala_method_get_return_type (_tmp2_);
		_tmp4_ = _tmp3_;
		_tmp5_ = vala_data_type_is_real_non_null_struct_type (_tmp4_);
		_tmp0_ = _tmp5_;
	}
	if (_tmp0_) {
		gchar* _tmp6_ = NULL;
	...
	cast_args = _tmp17_;
	_tmp18_ = m;
	_tmp19_ = vala_ccode_base_module_get_ccode_vfunc_name (_tmp18_);
	_tmp20_ = _tmp19_;
	_tmp21_ = vala_ccode_function_declarator_new (_tmp20_);
	_tmp22_ = _tmp21_;
	_g_free0 (_tmp20_);
	vdeclarator = _tmp22_;
	...
	_tmp29_ = cparam_map;
	_tmp30_ = vala_ccode_function_new ("fake", "void");
	_tmp31_ = _tmp30_;
	_tmp32_ = vdeclarator;
	_tmp33_ = direction;
	vala_ccode_base_module_generate_cparameters ((ValaCCodeBaseModule*) self, _tmp27_, _tmp28_, (ValaMap*) _tmp29_, _tmp31_, _tmp32_, NULL, NULL, _tmp33_);
	_vala_ccode_node_unref0 (_tmp31_);
	last_pos = -1;
	while (TRUE) {
		gint _tmp51_ = 0;
		...
		min_pos = -1;
		{
			...
			ValaSet* _tmp36_ = NULL;
			ValaIterator* _tmp37_ = NULL;
			ValaIterator* _tmp38_ = NULL;
			_tmp34_ = cparam_map;
			_tmp35_ = vala_map_get_keys ((ValaMap*) _tmp34_);
			_tmp36_ = _tmp35_;
			...
			while (TRUE) {
				...
				gint _tmp45_ = 0;
				_tmp39_ = _pos_it;
				_tmp40_ = vala_iterator_next (_tmp39_);
				if (!_tmp40_) {
					break;
				}
				_tmp41_ = _pos_it;
				_tmp42_ = vala_iterator_get (_tmp41_);
				pos = (gint) ((gintptr) _tmp42_);
				_tmp44_ = pos;
				_tmp45_ = last_pos;
				if (_tmp44_ > _tmp45_) {
		...
		if (_tmp51_ != -1) {
			...
			_tmp53_ = cparam_map;
			_tmp54_ = min_pos;
			_tmp55_ = vala_map_get ((ValaMap*) _tmp53_, (gpointer) ((gintptr) _tmp54_));
			tmp = (ValaCCodeParameter*) _tmp55_;
			_tmp56_ = tmp;
			_tmp57_ = vala_ccode_parameter_get_ellipsis (_tmp56_);
			_tmp58_ = _tmp57_;
			if (_tmp58_) {
				...
				_tmp61_ = cast_args;
				_tmp62_ = tmp;
				_tmp63_ = vala_ccode_parameter_get_type_name (_tmp62_);
				_tmp64_ = _tmp63_;
	...
	_tmp76_ = cfunc;
	_tmp77_ = cast;
	_tmp78_ = vala_ccode_cast_expression_new (_tmp76_, _tmp77_);
...
static void vala_gtype_module_class_init (ValaGTypeModuleClass * klass) {
	...
	((ValaCCodeBaseModuleClass *) klass)->get_param_spec = (ValaCCodeFunctionCall* (*)(ValaCCodeBaseModule*, ValaProperty*)) vala_gtype_module_real_get_param_spec;
