...
"d");
	...
	vala_code_node_accept_children ((ValaCodeNode*) _tmp38_, (ValaCodeVisitor*) self);
	{
		...
		while (TRUE) {
			...
			_tmp55_ = vala_hash_map_new (G_TYPE_INT, NULL, NULL, VALA_TYPE_CCODE_PARAMETER, (GBoxedCopyFunc) vala_ccode_node_ref, (GDestroyNotify) vala_ccode_node_unref, _tmp52_, _tmp53_, _tmp54_);
			_tmp56_ = _tmp55_;
...
static void vala_gsignal_module_class_init (ValaGSignalModuleClass * klass) {
	...
	((ValaCCodeBaseModuleClass *) klass)->get_signal_creation = (ValaCCodeFunctionCall* (*)(ValaCCodeBaseModule*, ValaSignal*, ValaTypeSymbol*)) vala_gsignal_module_real_get_signal_creation;
