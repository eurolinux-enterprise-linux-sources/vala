...
#define VALADOC_API_POINTER_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_API_TYPE_POINTER, ValadocApiPointerPrivate))
                               ...
                               void* data)
{
	...
	self = (ValadocApiPointer*) valadoc_api_item_construct (object_type, data);
...
valadoc_api_pointer_real_build_signature (ValadocApiItem* base)
{
	...
	_tmp6_ = _tmp5_;
	_tmp7_ = valadoc_api_signature_builder_append (_tmp6_, "*", FALSE);
	_tmp8_ = _tmp7_;
	_tmp9_ = valadoc_api_signature_builder_get (_tmp8_);
...
valadoc_api_pointer_class_init (ValadocApiPointerClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocApiPointerPrivate));
...
{
	self->priv = VALADOC_API_POINTER_GET_PRIVATE (self);
}
