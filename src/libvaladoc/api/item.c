...
#define VALADOC_API_ITEM_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_API_TYPE_ITEM, ValadocApiItemPrivate))
...
valadoc_api_item_class_init (ValadocApiItemClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocApiItemPrivate));
	...
	g_object_class_install_property (G_OBJECT_CLASS (klass), VALADOC_API_ITEM_DATA_PROPERTY, valadoc_api_item_properties[VALADOC_API_ITEM_DATA_PROPERTY] = g_param_spec_pointer ("data", "data", "data", G_PARAM_STATIC_STRINGS | G_PARAM_READABLE));
	/**
...
{
	self->priv = VALADOC_API_ITEM_GET_PRIVATE (self);
}
                                     ...
                                     GParamSpec * pspec)
{
	...
	switch (property_id) {
		...
		g_value_set_pointer (value, valadoc_api_item_get_data (self));
		break;
                                     ...
                                     GParamSpec * pspec)
{
	...
	switch (property_id) {
		case VALADOC_API_ITEM_DATA_PROPERTY:
		valadoc_api_item_set_data (self, g_value_get_pointer (value));
		break;
		case VALADOC_API_ITEM_PARENT_PROPERTY:
