...
#define VALADOC_API_SOURCE_COMMENT_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_API_TYPE_SOURCE_COMMENT, ValadocApiSourceCommentPrivate))
...
valadoc_api_source_comment_class_init (ValadocApiSourceCommentClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocApiSourceCommentPrivate));
}
...
{
	self->priv = VALADOC_API_SOURCE_COMMENT_GET_PRIVATE (self);
	self->ref_count = 1;
}
