...
#define VALADOC_API_CONSTANT_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_API_TYPE_CONSTANT, ValadocApiConstantPrivate))
                                ...
                                void* data)
{
	...
	self = (ValadocApiConstant*) valadoc_api_member_construct (object_type, parent, file, name, accessibility, comment, data);
...
valadoc_api_constant_real_build_signature (ValadocApiItem* base)
{
	...
	_tmp6_ = _tmp5_;
	_tmp7_ = valadoc_api_signature_builder_append_keyword (_tmp6_, "const", TRUE);
	_tmp8_ = _tmp7_;
	_tmp9_ = self->priv->_constant_type;
	_tmp10_ = valadoc_api_item_get_signature ((ValadocApiItem*) _tmp9_);
	_tmp11_ = _tmp10_;
	_tmp12_ = valadoc_api_signature_builder_append_content (_tmp8_, _tmp11_, TRUE);
	_tmp13_ = _tmp12_;
	_tmp14_ = valadoc_api_signature_builder_append_symbol (_tmp13_, (ValadocApiNode*) self, TRUE);
	_tmp15_ = _tmp14_;
	_tmp16_ = valadoc_api_signature_builder_get (_tmp15_);
	_tmp17_ = (ValadocContentInline*) _tmp16_;
...
valadoc_api_constant_class_init (ValadocApiConstantClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocApiConstantPrivate));
...
{
	self->priv = VALADOC_API_CONSTANT_GET_PRIVATE (self);
}
