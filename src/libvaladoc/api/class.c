...
#define VALADOC_API_CLASS_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_API_TYPE_CLASS, ValadocApiClassPrivate))
                             ...
                             void* data)
{
	...
	self = (ValadocApiClass*) valadoc_api_typesymbol_construct (object_type, parent, file, name, accessibility, comment, type_macro_name, is_type_macro_name, type_cast_macro_name, type_function_name, is_basic_type, data);
...
valadoc_api_class_real_build_signature (ValadocApiItem* base)
{
	...
	if (_tmp7_) {
		...
		_tmp8_ = signature;
		_tmp9_ = valadoc_api_signature_builder_append_keyword (_tmp8_, "abstract", TRUE);
		_tmp10_ = _tmp9_;
		_valadoc_api_signature_builder_unref0 (_tmp10_);
	}
	_tmp11_ = signature;
	_tmp12_ = valadoc_api_signature_builder_append_keyword (_tmp11_, "class", TRUE);
	_tmp13_ = _tmp12_;
	_valadoc_api_signature_builder_unref0 (_tmp13_);
	_tmp14_ = signature;
	_tmp15_ = valadoc_api_signature_builder_append_symbol (_tmp14_, (ValadocApiNode*) self, TRUE);
	_tmp16_ = _tmp15_;
	_valadoc_api_signature_builder_unref0 (_tmp16_);
	_tmp17_ = valadoc_api_node_get_children_by_type ((ValadocApiNode*) self, VALADOC_API_NODE_TYPE_TYPE_PARAMETER, FALSE);
	type_parameters = _tmp17_;
	_tmp18_ = type_parameters;
	...
	if (_tmp20_ > 0) {
		...
		_tmp21_ = signature;
		_tmp22_ = valadoc_api_signature_builder_append (_tmp21_, "<", FALSE);
		_tmp23_ = _tmp22_;
		...
		first = TRUE;
		{
			...
			while (TRUE) {
				...
				param = (ValadocApiItem*) ((ValadocApiNode*) _tmp34_);
				_tmp35_ = first;
				if (!_tmp35_) {
					...
					_tmp36_ = signature;
					_tmp37_ = valadoc_api_signature_builder_append (_tmp36_, ",", FALSE);
					_tmp38_ = _tmp37_;
					_valadoc_api_signature_builder_unref0 (_tmp38_);
				}
				_tmp39_ = signature;
				_tmp40_ = param;
				_tmp41_ = valadoc_api_item_get_signature (_tmp40_);
				_tmp42_ = _tmp41_;
				_tmp43_ = valadoc_api_signature_builder_append_content (_tmp39_, _tmp42_, FALSE);
				_tmp44_ = _tmp43_;
				_valadoc_api_signature_builder_unref0 (_tmp44_);
				first = FALSE;
		...
		_tmp45_ = signature;
		_tmp46_ = valadoc_api_signature_builder_append (_tmp45_, ">", FALSE);
		_tmp47_ = _tmp46_;
		_valadoc_api_signature_builder_unref0 (_tmp47_);
	}
	first = TRUE;
	_tmp48_ = self->priv->_base_type;
	if (_tmp48_ != NULL) {
		...
		_tmp52_ = signature;
		_tmp53_ = self->priv->_base_type;
		_tmp54_ = valadoc_api_item_get_signature ((ValadocApiItem*) _tmp53_);
		_tmp55_ = _tmp54_;
		_tmp56_ = valadoc_api_signature_builder_append_content (_tmp52_, _tmp55_, TRUE);
		_tmp57_ = _tmp56_;
		_valadoc_api_signature_builder_unref0 (_tmp57_);
		first = FALSE;
	}
	_tmp58_ = self->priv->interfaces;
	...
	if (_tmp60_ > 0) {
		...
		if (_tmp61_) {
			...
			_tmp62_ = signature;
			_tmp63_ = valadoc_api_signature_builder_append (_tmp62_, ":", TRUE);
			_tmp64_ = _tmp63_;
		...
		}
		{
			...
			_implemented_interface_list = _tmp66_;
			_tmp67_ = _implemented_interface_list;
			_tmp68_ = vala_collection_get_size ((ValaCollection*) _tmp67_);
			_tmp69_ = _tmp68_;
			_implemented_interface_size = _tmp69_;
			...
			while (TRUE) {
				...
				ValadocContentInline* _tmp82_;
				ValadocContentInline* _tmp83_;
				ValadocApiSignatureBuilder* _tmp84_;
				ValadocApiSignatureBuilder* _tmp85_;
				_tmp70_ = _implemented_interface_index;
				_implemented_interface_index = _tmp70_ + 1;
				_tmp71_ = _implemented_interface_index;
				_tmp72_ = _implemented_interface_size;
				if (!(_tmp71_ < _tmp72_)) {
					break;
				}
				_tmp73_ = _implemented_interface_list;
				_tmp74_ = _implemented_interface_index;
				_tmp75_ = vala_list_get ((ValaList*) _tmp73_, _tmp74_);
				implemented_interface = (ValadocApiItem*) ((ValadocApiTypeReference*) _tmp75_);
				_tmp76_ = first;
				if (!_tmp76_) {
					...
					_tmp77_ = signature;
					_tmp78_ = valadoc_api_signature_builder_append (_tmp77_, ",", FALSE);
					_tmp79_ = _tmp78_;
					_valadoc_api_signature_builder_unref0 (_tmp79_);
				}
				_tmp80_ = signature;
				_tmp81_ = implemented_interface;
				_tmp82_ = valadoc_api_item_get_signature (_tmp81_);
				_tmp83_ = _tmp82_;
				_tmp84_ = valadoc_api_signature_builder_append_content (_tmp80_, _tmp83_, TRUE);
				_tmp85_ = _tmp84_;
				_valadoc_api_signature_builder_unref0 (_tmp85_);
				first = FALSE;
...
valadoc_api_class_class_init (ValadocApiClassClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocApiClassPrivate));
...
valadoc_api_class_instance_init (ValadocApiClass * self)
{
	...
	GEqualFunc _tmp4_;
	ValaHashSet* _tmp5_;
	self->priv = VALADOC_API_CLASS_GET_PRIVATE (self);
