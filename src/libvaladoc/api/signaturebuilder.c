...
#define VALADOC_API_SIGNATURE_BUILDER_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_API_TYPE_SIGNATURE_BUILDER, ValadocApiSignatureBuilderPrivate))
                                      ...
                                      gboolean spaced)
{
	...
	_tmp4_ = _valadoc_api_signature_builder_ref0 (self);
	result = _tmp4_;
	_g_free0 (content);
	return result;
}
                                              ...
                                              gboolean spaced)
{
	...
	_tmp7_ = _valadoc_api_signature_builder_ref0 (self);
	result = _tmp7_;
	return result;
}
...
valadoc_api_signature_builder_class_init (ValadocApiSignatureBuilderClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocApiSignatureBuilderPrivate));
}
...
{
	self->priv = VALADOC_API_SIGNATURE_BUILDER_GET_PRIVATE (self);
	self->ref_count = 1;
}
