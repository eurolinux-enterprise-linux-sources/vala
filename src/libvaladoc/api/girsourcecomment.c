...
#define VALADOC_API_GIR_SOURCE_COMMENT_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_API_TYPE_GIR_SOURCE_COMMENT, ValadocApiGirSourceCommentPrivate))
...
valadoc_api_gir_source_comment_class_init (ValadocApiGirSourceCommentClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocApiGirSourceCommentPrivate));
}
...
valadoc_api_gir_source_comment_instance_init (ValadocApiGirSourceComment * self)
{
	...
	GEqualFunc _tmp2_;
	ValaHashMap* _tmp3_;
	self->priv = VALADOC_API_GIR_SOURCE_COMMENT_GET_PRIVATE (self);
	_tmp0_ = g_str_hash;
	_tmp1_ = g_str_equal;
