...
#define VALADOC_API_TREE_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_API_TYPE_TREE, ValadocApiTreePrivate))
                            ...
                            void* data)
{
	...
	valadoc_api_tree_set_data (self, data);
	return self;
}
...
valadoc_api_tree_new (ValadocErrorReporter* reporter,
                      ...
                      void* data)
{
	return valadoc_api_tree_construct (VALADOC_API_TYPE_TREE, reporter, settings, data);
}
...
void*
valadoc_api_tree_get_data (ValadocApiTree* self)
{
	void* result;
	void* _tmp0_;
	g_return_val_if_fail (self != NULL, NULL);
...
void
valadoc_api_tree_set_data (ValadocApiTree* self,
                           void* value)
{
	g_return_if_fail (self != NULL);
...
valadoc_api_tree_class_init (ValadocApiTreeClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocApiTreePrivate));
}
...
valadoc_api_tree_instance_init (ValadocApiTree * self)
{
	...
	GEqualFunc _tmp4_;
	ValaArrayList* _tmp5_;
	self->priv = VALADOC_API_TREE_GET_PRIVATE (self);
