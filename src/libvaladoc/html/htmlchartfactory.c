...
#define VALADOC_HTML_SIMPLE_CHART_FACTORY_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_HTML_TYPE_SIMPLE_CHART_FACTORY, ValadocHtmlSimpleChartFactoryPrivate))
...
valadoc_html_simple_chart_factory_class_init (ValadocHtmlSimpleChartFactoryClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocHtmlSimpleChartFactoryPrivate));
...
{
	self->priv = VALADOC_HTML_SIMPLE_CHART_FACTORY_GET_PRIVATE (self);
}
