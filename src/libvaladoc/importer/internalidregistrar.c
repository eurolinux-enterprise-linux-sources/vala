...
#define VALADOC_IMPORTER_INTERNAL_ID_REGISTRAR_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_IMPORTER_TYPE_INTERNAL_ID_REGISTRAR, ValadocImporterInternalIdRegistrarPrivate))
...
valadoc_importer_internal_id_registrar_class_init (ValadocImporterInternalIdRegistrarClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocImporterInternalIdRegistrarPrivate));
}
...
{
	self->priv = VALADOC_IMPORTER_INTERNAL_ID_REGISTRAR_GET_PRIVATE (self);
	self->ref_count = 1;
}
