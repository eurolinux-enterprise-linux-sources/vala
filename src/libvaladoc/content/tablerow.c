...
#define VALADOC_CONTENT_TABLE_ROW_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_CONTENT_TYPE_TABLE_ROW, ValadocContentTableRowPrivate))
...
valadoc_content_table_row_class_init (ValadocContentTableRowClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocContentTableRowPrivate));
...
{
	self->priv = VALADOC_CONTENT_TABLE_ROW_GET_PRIVATE (self);
}
