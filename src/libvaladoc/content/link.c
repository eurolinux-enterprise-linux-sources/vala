...
#define VALADOC_CONTENT_LINK_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_CONTENT_TYPE_LINK, ValadocContentLinkPrivate))
...
valadoc_content_link_class_init (ValadocContentLinkClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocContentLinkPrivate));
...
{
	self->priv = VALADOC_CONTENT_LINK_GET_PRIVATE (self);
}
