...
#define VALADOC_CONTENT_SYMBOL_LINK_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_CONTENT_TYPE_SYMBOL_LINK, ValadocContentSymbolLinkPrivate))
...
valadoc_content_symbol_link_class_init (ValadocContentSymbolLinkClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocContentSymbolLinkPrivate));
...
{
	self->priv = VALADOC_CONTENT_SYMBOL_LINK_GET_PRIVATE (self);
}
