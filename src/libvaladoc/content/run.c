...
#define VALADOC_CONTENT_RUN_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_CONTENT_TYPE_RUN, ValadocContentRunPrivate))
...
valadoc_content_run_class_init (ValadocContentRunClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocContentRunPrivate));
...
{
	self->priv = VALADOC_CONTENT_RUN_GET_PRIVATE (self);
}
