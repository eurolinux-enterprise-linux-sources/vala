...
#define VALADOC_CONTENT_CONTENT_ELEMENT_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_CONTENT_TYPE_CONTENT_ELEMENT, ValadocContentContentElementPrivate))
...
valadoc_content_content_element_class_init (ValadocContentContentElementClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocContentContentElementPrivate));
...
{
	self->priv = VALADOC_CONTENT_CONTENT_ELEMENT_GET_PRIVATE (self);
}
