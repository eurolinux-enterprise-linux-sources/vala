...
#define VALADOC_CONTENT_BLOCK_CONTENT_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_CONTENT_TYPE_BLOCK_CONTENT, ValadocContentBlockContentPrivate))
...
valadoc_content_block_content_class_init (ValadocContentBlockContentClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocContentBlockContentPrivate));
...
{
	self->priv = VALADOC_CONTENT_BLOCK_CONTENT_GET_PRIVATE (self);
}
