...
#define VALADOC_CONTENT_TABLE_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_CONTENT_TYPE_TABLE, ValadocContentTablePrivate))
...
valadoc_content_table_class_init (ValadocContentTableClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocContentTablePrivate));
...
{
	self->priv = VALADOC_CONTENT_TABLE_GET_PRIVATE (self);
}
