...
#define VALADOC_CONTENT_CONTENT_FACTORY_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_CONTENT_TYPE_CONTENT_FACTORY, ValadocContentContentFactoryPrivate))
...
valadoc_content_content_factory_class_init (ValadocContentContentFactoryClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocContentContentFactoryPrivate));
...
{
	self->priv = VALADOC_CONTENT_CONTENT_FACTORY_GET_PRIVATE (self);
}
