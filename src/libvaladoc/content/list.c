...
#define VALADOC_CONTENT_LIST_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_CONTENT_TYPE_LIST, ValadocContentListPrivate))
...
valadoc_content_list_class_init (ValadocContentListClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocContentListPrivate));
...
{
	self->priv = VALADOC_CONTENT_LIST_GET_PRIVATE (self);
}
