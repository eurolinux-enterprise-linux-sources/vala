...
#define VALADOC_CONTENT_HEADLINE_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_CONTENT_TYPE_HEADLINE, ValadocContentHeadlinePrivate))
...
valadoc_content_headline_class_init (ValadocContentHeadlineClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocContentHeadlinePrivate));
...
{
	self->priv = VALADOC_CONTENT_HEADLINE_GET_PRIVATE (self);
}
