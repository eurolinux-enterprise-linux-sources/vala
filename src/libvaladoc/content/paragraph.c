...
#define VALADOC_CONTENT_PARAGRAPH_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_CONTENT_TYPE_PARAGRAPH, ValadocContentParagraphPrivate))
...
valadoc_content_paragraph_class_init (ValadocContentParagraphClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocContentParagraphPrivate));
...
{
	self->priv = VALADOC_CONTENT_PARAGRAPH_GET_PRIVATE (self);
}
