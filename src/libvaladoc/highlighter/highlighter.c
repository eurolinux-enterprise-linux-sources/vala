...
#define VALADOC_HIGHLIGHTER_HIGHLIGHTER_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_HIGHLIGHTER_TYPE_HIGHLIGHTER, ValadocHighlighterHighlighterPrivate))
...
valadoc_highlighter_highlighter_class_init (ValadocHighlighterHighlighterClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocHighlighterHighlighterPrivate));
...
{
	self->priv = VALADOC_HIGHLIGHTER_HIGHLIGHTER_GET_PRIVATE (self);
}
