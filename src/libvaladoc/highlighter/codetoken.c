...
#define VALADOC_HIGHLIGHTER_CODE_TOKEN_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_HIGHLIGHTER_TYPE_CODE_TOKEN, ValadocHighlighterCodeTokenPrivate))
...
valadoc_highlighter_code_token_class_init (ValadocHighlighterCodeTokenClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocHighlighterCodeTokenPrivate));
}
...
{
	self->priv = VALADOC_HIGHLIGHTER_CODE_TOKEN_GET_PRIVATE (self);
	self->ref_count = 1;
}
