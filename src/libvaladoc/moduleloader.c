...
#define VALADOC_MODULE_LOADER_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_TYPE_MODULE_LOADER, ValadocModuleLoaderPrivate))
...
valadoc_module_loader_class_init (ValadocModuleLoaderClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocModuleLoaderPrivate));
...
valadoc_module_loader_instance_init (ValadocModuleLoader * self)
{
	...
	GEqualFunc _tmp6_;
	ValaHashMap* _tmp7_;
	self->priv = VALADOC_MODULE_LOADER_GET_PRIVATE (self);
	_tmp0_ = g_str_hash;
	_tmp1_ = g_str_equal;
