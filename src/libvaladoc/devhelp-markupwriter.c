                                          ...
                                          const gchar* author)
{
	...
	_tmp15_ = _tmp14_;
	_tmp15__length1 = 14;
	_tmp16_ = valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) self, "book", _tmp15_, 14);
	_tmp17_ = _tmp16_;
...
valadoc_devhelp_markup_writer_end_book (ValadocDevhelpMarkupWriter* self)
{
	...
	ValadocDevhelpMarkupWriter* _tmp2_;
	g_return_val_if_fail (self != NULL, NULL);
	_tmp0_ = valadoc_markup_writer_end_tag ((ValadocMarkupWriter*) self, "book");
	_tmp1_ = _tmp0_;
	_valadoc_markup_writer_unref0 (_tmp1_);
	_tmp2_ = _valadoc_markup_writer_ref0 (self);
	result = _tmp2_;
	return result;
}
...
valadoc_devhelp_markup_writer_start_functions (ValadocDevhelpMarkupWriter* self)
{
	...
	ValadocDevhelpMarkupWriter* _tmp2_;
	g_return_val_if_fail (self != NULL, NULL);
	_tmp0_ = valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) self, "functions", NULL, 0);
	_tmp1_ = _tmp0_;
	_valadoc_markup_writer_unref0 (_tmp1_);
	_tmp2_ = _valadoc_markup_writer_ref0 (self);
	result = _tmp2_;
...
valadoc_devhelp_markup_writer_end_functions (ValadocDevhelpMarkupWriter* self)
{
	...
	ValadocDevhelpMarkupWriter* _tmp2_;
	g_return_val_if_fail (self != NULL, NULL);
	_tmp0_ = valadoc_markup_writer_end_tag ((ValadocMarkupWriter*) self, "functions");
	_tmp1_ = _tmp0_;
	_valadoc_markup_writer_unref0 (_tmp1_);
	_tmp2_ = _valadoc_markup_writer_ref0 (self);
	result = _tmp2_;
...
valadoc_devhelp_markup_writer_start_chapters (ValadocDevhelpMarkupWriter* self)
{
	...
	ValadocDevhelpMarkupWriter* _tmp2_;
	g_return_val_if_fail (self != NULL, NULL);
	_tmp0_ = valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) self, "chapters", NULL, 0);
	_tmp1_ = _tmp0_;
	_valadoc_markup_writer_unref0 (_tmp1_);
	_tmp2_ = _valadoc_markup_writer_ref0 (self);
	result = _tmp2_;
...
valadoc_devhelp_markup_writer_end_chapters (ValadocDevhelpMarkupWriter* self)
{
	...
	ValadocDevhelpMarkupWriter* _tmp2_;
	g_return_val_if_fail (self != NULL, NULL);
	_tmp0_ = valadoc_markup_writer_end_tag ((ValadocMarkupWriter*) self, "chapters");
	_tmp1_ = _tmp0_;
	_valadoc_markup_writer_unref0 (_tmp1_);
	_tmp2_ = _valadoc_markup_writer_ref0 (self);
	result = _tmp2_;
                                         ...
                                         const gchar* link)
{
	...
	ValadocDevhelpMarkupWriter* _tmp8_;
	g_return_val_if_fail (self != NULL, NULL);
	g_return_val_if_fail (name != NULL, NULL);
	g_return_val_if_fail (link != NULL, NULL);
	...
	_tmp5_ = _tmp4_;
	_tmp5__length1 = 4;
	_tmp6_ = valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) self, "sub", _tmp5_, 4);
	_tmp7_ = _tmp6_;
...
valadoc_devhelp_markup_writer_end_sub (ValadocDevhelpMarkupWriter* self)
{
	...
	ValadocDevhelpMarkupWriter* _tmp2_;
	g_return_val_if_fail (self != NULL, NULL);
	_tmp0_ = valadoc_markup_writer_end_tag ((ValadocMarkupWriter*) self, "sub");
	_tmp1_ = _tmp0_;
	_valadoc_markup_writer_unref0 (_tmp1_);
	_tmp2_ = _valadoc_markup_writer_ref0 (self);
	result = _tmp2_;
                                       ...
                                       const gchar* link)
{
	...
	ValadocDevhelpMarkupWriter* _tmp12_;
	g_return_val_if_fail (self != NULL, NULL);
	g_return_val_if_fail (name != NULL, NULL);
	...
	_tmp7_ = _tmp6_;
	_tmp7__length1 = 6;
	_tmp8_ = valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) self, "keyword", _tmp7_, 6);
	_tmp9_ = _tmp8_;
	_valadoc_markup_writer_unref0 (_tmp9_);
	_tmp7_ = (_vala_array_free (_tmp7_, _tmp7__length1, (GDestroyNotify) g_free), NULL);
	_tmp10_ = valadoc_markup_writer_end_tag ((ValadocMarkupWriter*) self, "keyword");
	_tmp11_ = _tmp10_;
	_valadoc_markup_writer_unref0 (_tmp11_);
	_tmp12_ = _valadoc_markup_writer_ref0 (self);
	result = _tmp12_;
	return result;
}
