...
#define VALADOC_GTK_DOC_MARKUP_WRITER_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_TYPE_GTK_DOC_MARKUP_WRITER, ValadocGtkDocMarkupWriterPrivate))
...
valadoc_gtk_doc_markup_writer_class_init (ValadocGtkDocMarkupWriterClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocGtkDocMarkupWriterPrivate));
...
{
	self->priv = VALADOC_GTK_DOC_MARKUP_WRITER_GET_PRIVATE (self);
}
