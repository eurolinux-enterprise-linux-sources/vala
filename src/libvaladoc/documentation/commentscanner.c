...
#define VALADOC_COMMENT_SCANNER_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_TYPE_COMMENT_SCANNER, ValadocCommentScannerPrivate))
...
valadoc_comment_scanner_class_init (ValadocCommentScannerClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocCommentScannerPrivate));
...
{
	self->priv = VALADOC_COMMENT_SCANNER_GET_PRIVATE (self);
}
