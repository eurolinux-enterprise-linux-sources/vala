...
#define VALADOC_RULE_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_TYPE_RULE, ValadocRulePrivate))
...
valadoc_rule_class_init (ValadocRuleClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocRulePrivate));
...
{
	self->priv = VALADOC_RULE_GET_PRIVATE (self);
