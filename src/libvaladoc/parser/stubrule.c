...
#define VALADOC_STUB_RULE_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_TYPE_STUB_RULE, ValadocStubRulePrivate))
...
valadoc_stub_rule_class_init (ValadocStubRuleClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocStubRulePrivate));
...
{
	self->priv = VALADOC_STUB_RULE_GET_PRIVATE (self);
}
