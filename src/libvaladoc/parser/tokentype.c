...
#define VALADOC_TOKEN_TYPE_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_TYPE_TOKEN_TYPE, ValadocTokenTypePrivate))
...
valadoc_token_type_class_init (ValadocTokenTypeClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocTokenTypePrivate));
...
{
	self->priv = VALADOC_TOKEN_TYPE_GET_PRIVATE (self);
