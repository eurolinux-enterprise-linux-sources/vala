...
#define VALADOC_TAGLETS_SINCE_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_TAGLETS_TYPE_SINCE, ValadocTagletsSincePrivate))
...
valadoc_taglets_since_class_init (ValadocTagletsSinceClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocTagletsSincePrivate));
...
{
	self->priv = VALADOC_TAGLETS_SINCE_GET_PRIVATE (self);
}
