...
#define VALADOC_TAGLETS_SEE_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_TAGLETS_TYPE_SEE, ValadocTagletsSeePrivate))
...
valadoc_taglets_see_class_init (ValadocTagletsSeeClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocTagletsSeePrivate));
...
{
	self->priv = VALADOC_TAGLETS_SEE_GET_PRIVATE (self);
}
