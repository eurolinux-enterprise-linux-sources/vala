...
#define VALADOC_TAGLETS_THROWS_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_TAGLETS_TYPE_THROWS, ValadocTagletsThrowsPrivate))
...
valadoc_taglets_throws_class_init (ValadocTagletsThrowsClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocTagletsThrowsPrivate));
...
{
	self->priv = VALADOC_TAGLETS_THROWS_GET_PRIVATE (self);
}
