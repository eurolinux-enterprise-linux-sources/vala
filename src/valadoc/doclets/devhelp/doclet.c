...
#define VALADOC_DEVHELP_DOCLET_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_DEVHELP_TYPE_DOCLET, ValadocDevhelpDocletPrivate))
                                           ...
                                           ValadocApiPackage* package)
{
	...
	gchar* _tmp32_;
	const gchar* _tmp33_;
	ValadocDevhelpMarkupWriter* _tmp34_;
	ValadocDevhelpMarkupWriter* _tmp35_;
	FILE* file = NULL;
	const gchar* _tmp36_;
	FILE* _tmp37_;
	FILE* _tmp38_;
	ValadocHtmlMarkupWriter* _tmp39_;
	ValadocHtmlHtmlRenderer* _tmp40_;
	...
	ValadocDevhelpMarkupWriter* _tmp47_;
	ValadocDevhelpMarkupWriter* _tmp48_;
	ValadocDevhelpMarkupWriter* _tmp49_;
	ValadocDevhelpMarkupWriter* _tmp50_;
	ValadocDevhelpMarkupWriter* _tmp51_;
	ValadocDevhelpMarkupWriter* _tmp95_;
	ValadocDevhelpMarkupWriter* _tmp96_;
	ValadocDevhelpMarkupWriter* _tmp97_;
	ValadocDevhelpMarkupWriter* _tmp98_;
	ValadocDevhelpMarkupWriter* _tmp99_;
	ValadocDevhelpMarkupWriter* _tmp100_;
	self = (ValadocDevhelpDoclet*) base;
	...
	_tmp32_ = _tmp31_;
	_tmp33_ = pkg_name;
	_tmp34_ = valadoc_devhelp_markup_writer_start_book (_tmp29_, _tmp32_, "vala", "index.htm", _tmp33_, "", "");
	_tmp35_ = _tmp34_;
	_valadoc_markup_writer_unref0 (_tmp35_);
	_g_free0 (_tmp32_);
	_tmp36_ = filepath;
	_tmp37_ = g_fopen (_tmp36_, "w");
	file = _tmp37_;
	_tmp38_ = file;
	_tmp39_ = valadoc_html_markup_writer_new (_tmp38_, TRUE);
	_valadoc_markup_writer_unref0 (((ValadocHtmlBasicDoclet*) self)->writer);
	((ValadocHtmlBasicDoclet*) self)->writer = _tmp39_;
	_tmp40_ = ((ValadocHtmlBasicDoclet*) self)->_renderer;
	_tmp41_ = ((ValadocHtmlBasicDoclet*) self)->writer;
	valadoc_html_html_renderer_set_writer (_tmp40_, _tmp41_);
	_tmp42_ = pkg_name;
	valadoc_html_basic_doclet_write_file_header ((ValadocHtmlBasicDoclet*) self, VALADOC_DEVHELP_DOCLET_css_path, VALADOC_DEVHELP_DOCLET_js_path, _tmp42_);
	...
	_tmp44_ = valadoc_devhelp_markup_writer_start_chapters (_tmp43_);
	_tmp45_ = _tmp44_;
	...
	_tmp47_ = valadoc_devhelp_markup_writer_end_chapters (_tmp46_);
	_tmp48_ = _tmp47_;
	_valadoc_markup_writer_unref0 (_tmp48_);
	_tmp49_ = self->priv->_devhelpwriter;
	_tmp50_ = valadoc_devhelp_markup_writer_start_functions (_tmp49_);
	_tmp51_ = _tmp50_;
	_valadoc_markup_writer_unref0 (_tmp51_);
	{
		...
		while (TRUE) {
			...
			ValadocDevhelpMarkupWriter* _tmp78_;
			gchar* _tmp79_;
			const gchar* _tmp80_;
			gchar* _tmp81_;
			gchar* _tmp82_;
			...
			node = (ValadocApiNode*) _tmp62_;
			_tmp63_ = g_strdup ("");
			typekeyword = _tmp63_;
			_tmp64_ = node;
			if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp64_, VALADOC_API_TYPE_ENUM)) {
				gchar* _tmp65_;
				_tmp65_ = g_strdup ("enum");
				_g_free0 (typekeyword);
				typekeyword = _tmp65_;
			} else {
				ValadocApiNode* _tmp66_;
				_tmp66_ = node;
				if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp66_, VALADOC_API_TYPE_CONSTANT)) {
					gchar* _tmp67_;
					_tmp67_ = g_strdup ("constant");
					_g_free0 (typekeyword);
					typekeyword = _tmp67_;
				} else {
					ValadocApiNode* _tmp68_;
					_tmp68_ = node;
					if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp68_, VALADOC_API_TYPE_METHOD)) {
						gchar* _tmp69_;
						_tmp69_ = g_strdup ("function");
						_g_free0 (typekeyword);
						typekeyword = _tmp69_;
					} else {
						ValadocApiNode* _tmp70_;
						_tmp70_ = node;
						if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp70_, VALADOC_API_TYPE_FIELD)) {
							gchar* _tmp71_;
							_tmp71_ = g_strdup ("variable");
							_g_free0 (typekeyword);
							typekeyword = _tmp71_;
						} else {
							ValadocApiNode* _tmp72_;
							_tmp72_ = node;
							if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp72_, VALADOC_API_TYPE_PROPERTY)) {
								gchar* _tmp73_;
								_tmp73_ = g_strdup ("property");
								_g_free0 (typekeyword);
								typekeyword = _tmp73_;
							} else {
								ValadocApiNode* _tmp74_;
								_tmp74_ = node;
								if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp74_, VALADOC_API_TYPE_SIGNAL)) {
									gchar* _tmp75_;
									_tmp75_ = g_strdup ("signal");
									_g_free0 (typekeyword);
									typekeyword = _tmp75_;
								} else {
									ValadocApiNode* _tmp76_;
									_tmp76_ = node;
									if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp76_, VALADOC_API_TYPE_STRUCT)) {
										gchar* _tmp77_;
										_tmp77_ = g_strdup ("struct");
										_g_free0 (typekeyword);
										typekeyword = _tmp77_;
									}
								}
			...
			_tmp78_ = self->priv->_devhelpwriter;
			_tmp79_ = g_strdup ("type");
			_tmp80_ = typekeyword;
			_tmp81_ = g_strdup (_tmp80_);
			_tmp82_ = g_strdup ("name");
			_tmp83_ = node;
			_tmp84_ = valadoc_api_node_get_full_name (_tmp83_);
			_tmp85_ = g_strdup ("link");
			_tmp86_ = node;
			_tmp87_ = node;
			_tmp88_ = valadoc_documentation_get_package ((ValadocDocumentation*) _tmp87_);
			_tmp89_ = _tmp88_;
			_tmp90_ = valadoc_html_basic_doclet_get_link ((ValadocHtmlBasicDoclet*) self, _tmp86_, (ValadocApiNode*) _tmp89_);
			_tmp91_ = g_new0 (gchar*, 6 + 1);
			_tmp91_[0] = _tmp79_;
			_tmp91_[1] = _tmp81_;
			_tmp91_[2] = _tmp82_;
			_tmp91_[3] = _tmp84_;
			...
			_tmp92_ = _tmp91_;
			_tmp92__length1 = 6;
			_tmp93_ = valadoc_markup_writer_simple_tag ((ValadocMarkupWriter*) _tmp78_, "keyword", _tmp92_, 6);
			_tmp94_ = _tmp93_;
	...
	_tmp95_ = self->priv->_devhelpwriter;
	_tmp96_ = valadoc_devhelp_markup_writer_end_functions (_tmp95_);
	_tmp97_ = _tmp96_;
	_valadoc_markup_writer_unref0 (_tmp97_);
	_tmp98_ = self->priv->_devhelpwriter;
	_tmp99_ = valadoc_devhelp_markup_writer_end_book (_tmp98_);
	_tmp100_ = _tmp99_;
                                              ...
                                              ValadocApiNode* node)
{
	...
	if (_tmp21_ != NULL) {
		...
		ValadocDevhelpMarkupWriter* _tmp27_;
		ValadocDevhelpMarkupWriter* _tmp28_;
		ValadocDevhelpMarkupWriter* _tmp29_;
		ValadocDevhelpMarkupWriter* _tmp30_;
		ValaArrayList* _tmp31_;
		_tmp22_ = self->priv->_devhelpwriter;
		_tmp23_ = valadoc_api_node_get_name (node);
		_tmp24_ = _tmp23_;
		_tmp25_ = path;
		_tmp26_ = valadoc_devhelp_markup_writer_start_sub (_tmp22_, _tmp24_, _tmp25_);
		_tmp27_ = _tmp26_;
		_valadoc_markup_writer_unref0 (_tmp27_);
		valadoc_api_node_accept_all_children (node, (ValadocApiVisitor*) self, TRUE);
		_tmp28_ = self->priv->_devhelpwriter;
		_tmp29_ = valadoc_devhelp_markup_writer_end_sub (_tmp28_);
		_tmp30_ = _tmp29_;
		_valadoc_markup_writer_unref0 (_tmp30_);
		_tmp31_ = self->priv->nodes;
		vala_collection_add ((ValaCollection*) _tmp31_, node);
	} else {
		valadoc_api_node_accept_all_children (node, (ValadocApiVisitor*) self, TRUE);
	}
	_g_free0 (path);
                                     ...
                                     gboolean accept_all_children)
{
	...
	if (accept_all_children) {
		...
		const gchar* _tmp21_;
		ValadocDevhelpMarkupWriter* _tmp22_;
		ValadocDevhelpMarkupWriter* _tmp23_;
		ValadocDevhelpMarkupWriter* _tmp24_;
		ValadocDevhelpMarkupWriter* _tmp25_;
		ValadocDevhelpMarkupWriter* _tmp26_;
		_tmp18_ = self->priv->_devhelpwriter;
		_tmp19_ = valadoc_api_node_get_name (node);
		_tmp20_ = _tmp19_;
		_tmp21_ = path;
		_tmp22_ = valadoc_devhelp_markup_writer_start_sub (_tmp18_, _tmp20_, _tmp21_);
		_tmp23_ = _tmp22_;
		_valadoc_markup_writer_unref0 (_tmp23_);
		valadoc_api_node_accept_all_children (node, (ValadocApiVisitor*) self, TRUE);
		_tmp24_ = self->priv->_devhelpwriter;
		_tmp25_ = valadoc_devhelp_markup_writer_end_sub (_tmp24_);
		_tmp26_ = _tmp25_;
...
valadoc_devhelp_doclet_class_init (ValadocDevhelpDocletClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocDevhelpDocletPrivate));
...
valadoc_devhelp_doclet_instance_init (ValadocDevhelpDoclet * self)
{
	...
	gchar* _tmp2_;
	self->priv = VALADOC_DEVHELP_DOCLET_GET_PRIVATE (self);
