...
#define VALADOC_DRIVERS_SYMBOL_RESOLVER_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALADOC_DRIVERS_TYPE_SYMBOL_RESOLVER, ValadocDriversSymbolResolverPrivate))
...
valadoc_drivers_symbol_resolver_class_init (ValadocDriversSymbolResolverClass * klass)
{
	...
	g_type_class_add_private (klass, sizeof (ValadocDriversSymbolResolverPrivate));
...
{
	self->priv = VALADOC_DRIVERS_SYMBOL_RESOLVER_GET_PRIVATE (self);
}
